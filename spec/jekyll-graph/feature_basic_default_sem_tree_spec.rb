...
RSpec.describe(Jekyll::Graph::Generator) do
  ...
  context "GRAPH TYPE: TREE" do
      ...
      context "dependencies" do
        ...
        context "if 'tree' is enabled, but 'jekyll-semtree' not enabled (or installed)" do
          let(:config_overrides) { { "semtree" => { "enabled" => false } } }
          pending("todo: this is hard to test because i need to somehow mock the lack of plugin installation")

          # it "throw error if jekyll-semtree' 'tree' is missing" do
